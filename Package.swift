...
let package = Package(
    ...
    targets: [
        ...
        .testTarget(name: "SwiftCodeTerminalUITests", dependencies: ["SwiftCodeTerminalUI", "SwiftCodeNative"]),
        .testTarget(name: "SwiftCodeToolsTests", dependencies: ["SwiftCodeTools", "SwiftCodeCore"]),
